          ...
          <div className="footer-content">
            <div className="footer-main">
              ...
              <div className="footer-text">
                <p>
                  <span>Znáte důležité informace ze zdravotnictví</span>,<br /> které by mohly být přínosné pro ostatní? <br /> <span>Jste z obcí a měst</span>, které nabízí benefity pro zdravotníky a nejste zde uvedeni, <span>napište nám</span>. <br /> <br /> Vaše zpětná vazba je pro nás důležitá. <br /> E-mail: <span>zdravi@pardubickykraj.cz</span>
                </p>
              </div>
            </div>
